    ...
    <div class="row">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                <h1 class="h2">Tambah Data Absensi</h1>
                    ...
                    <div class="col-md-7">
                        ...
                        <div class="w-100">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control <?= (isset($errors['nama_jadwal'])) ? 'is-invalid' : '' ?>" name="nama_jadwal" id="nama_jadwal" placeholder="Nama Absensi" value="<?= old('nama_jadwal') ?>">
                            ...
                            <div class="mb-3">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control <?= (isset($errors['jam_masuk'])) ? 'is-invalid' : '' ?>" name="jam_masuk" id="jam_masuk" placeholder="07:00" value="<?= old('jam_masuk') ?>" maxlength="5">
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control <?= (isset($errors['batas_jam_masuk'])) ? 'is-invalid' : '' ?>" name="batas_jam_masuk" id="batas_jam_masuk" placeholder="08:00" value="<?= old('batas_jam_masuk') ?>" maxlength="5">
                                        <div class="invalid-feedback">
                            ...
                            <div class="mb-3">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control <?= (isset($errors['jam_pulang'])) ? 'is-invalid' : '' ?>" name="jam_pulang" id="jam_pulang" placeholder="16:00" value="<?= old('jam_pulang') ?>" maxlength="5">
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control <?= (isset($errors['batas_jam_pulang'])) ? 'is-invalid' : '' ?>" name="batas_jam_pulang" id="batas_jam_pulang" placeholder="17:00" value="<?= old('batas_jam_pulang') ?>" maxlength="5">
                                        <div class="invalid-feedback">
